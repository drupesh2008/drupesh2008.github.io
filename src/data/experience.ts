...
export const experiences: CompanyExperience[] = [
  {
    ...
    bullets: [
      "Built the e-KYC onboarding platform for retail (individual) clients in 10 weeks — the digital front door bringing millions of customers into the firm's financial services",
  ...
  },
  {
    ...
    bullets: [
      "Optimized the maps, geocoding, and geolocation APIs serving 1 billion daily requests across 100K+ developers",
      "Built job schedulers processing 10-20M jobs/day and a data-enrichment pipeline parsing 4.8M records daily against 200M cell towers and 4B WiFi access points — locating devices without GPS",
    ],
    techTags: [
      { name: "PHP", color: "teal" },
